...
export class RoomSelectorComponent implements OnInit, OnDestroy {
  ...
  isIE = !!(navigator.userAgent.match(/Trident/) || navigator.userAgent.match(/MSIE/) || navigator.userAgent.match(/Edge/));
  ...
  constructor(private location: Location, private locationStrategy: LocationStrategy, private themeService: NbThemeService) {
    this.selectRoom('2');
  }
